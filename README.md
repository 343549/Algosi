...
Все программы прошли тестирование и корректно работают с различными входными данными, включая граничные случаи.
...
**Результаты:**
Программа успешно вычисляет числа Фибоначчи для всех значений n в диапазоне [0, 45] за оптимальное время, используя минимальное количество памяти.
...
**Результаты:**
Программа успешно обрабатывает значения `n` до 10⁷, вычисляя последнюю цифру за константное время, что невозможно было бы при вычислении полного числа Фибоначчи.
...
Все алгоритмы успешно прошли тестирование и работают в пределах заданных временных ограничений (5 секунд).
