...
- **Входной файл:** `task4/input.txt` - содержит числа для вставки в дерево
- **Выходной файл:** `task4/output.txt` - содержит результаты выполнения программы
...
### Входные и выходные файлы
- **Входной файл:** `task8/input.txt` - содержит три строки:
  1. Элементы для вставки в дерево
  2. Элементы для поиска (существующие)
  3. Элементы для поиска (несуществующие)
- **Выходной файл:** `task8/output.txt` - содержит результаты выполнения программы
...
### Входные и выходные файлы
- **Входной файл:** `task9/input.txt` - содержит две строки:
  1. Элементы для вставки в дерево
  2. Элементы для удаления из дерева
- **Выходной файл:** `task9/output.txt` - содержит результаты выполнения программы
...
### Входные и выходные файлы
- **Входной файл:** `task14/input.txt` - содержит шесть строк:
  1. Элементы для вставки в дерево
  2. Значения k для поиска k-го наименьшего элемента
  3. Значения k для поиска k-го наибольшего элемента
  4. Диапазон [min, max] для первого поиска
  5. Диапазон [min, max] для второго поиска
  6. Элементы для поиска предшественника и преемника
- **Выходной файл:** `task14/output.txt` - содержит результаты выполнения программы
...
### Входные и выходные файлы
- **Входной файл:** `task17/input.txt` - содержит четыре строки:
  1. Элементы для создания несбалансированного дерева
  2. Отсортированный массив для создания сбалансированного дерева
  3. Элементы для тестирования поиска
  4. Большой отсортированный массив для создания большого сбалансированного дерева
- **Выходной файл:** `task17/output.txt` - содержит результаты выполнения программы
