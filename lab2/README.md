...
```
Компания: Озон
Период изменения цен акций: 01.01.2024 - 31.01.2024
Дата покупки: 2024-01-01
Дата продажи: 2024-01-31
Максимальная прибыль: 205.30
```

**Примечание:** Использованы данные акций компании Озон за январь 2024 года. Данные можно получить, скачав исторические данные с Google Finance (поиск "акции Озон" → Настройки → Скачать).
...
РЕЗУЛЬТАТ:
============================================================
Дата покупки: 2024-01-01 (цена: 2850.50)
Дата продажи: 2024-01-31 (цена: 3055.80)
Максимальная прибыль: 205.30
============================================================
```
